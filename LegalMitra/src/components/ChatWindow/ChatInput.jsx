    ...
    <div className='flex justify-center px-6 py-5'>
       <div className=" w-full max-w-2xl rounded-3xl border border-zinc-700 bg-[#2A2A2A] transition-all duration-200 focus-within:border-violet-500">
          ...
          <div className='flex items-center gap-3 px-5 py-3'>
            ...
            <button className='flex h-10 w-10 items-center justify-center rounded-full bg-violet-500 transition-colors duration-200 hover:bg-violet-700'> <SendHorizonal size={18} className='text-white'/></button>
          </div>
        </div>
